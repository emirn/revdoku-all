...
ActiveRecord::Schema[8.1].define(version: 2026_04_27_090000) do
  ...
  create_table "accounts", force: :cascade do |t|
    t.text "ai_provider_keys_ciphertext"
    t.datetime "audit_access_for_support_expires_at"
    t.datetime "created_at", null: false
    t.integer "credits_purchased", default: 0, null: false
    t.datetime "credits_purchased_expire_at"
    t.integer "credits_subscription", default: 0, null: false
    ...
    t.string "default_text_extraction_model"
    ...
    t.string "preferred_region", default: "any", null: false
    t.string "prefix_id"
    t.string "previous_subscription_sku"
    t.integer "security_level", default: 0, null: false
    t.datetime "setup_completed_at"
    t.datetime "storage_credits_charged_at"
    t.datetime "updated_at", null: false
    t.index ["inbound_token"], name: "index_accounts_on_inbound_token", unique: true
  ...
  create_table "checklist_templates", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.boolean "default_for_new_account", default: false, null: false
    t.string "name", null: false
    t.json "rules", default: []
    t.integer "sort_order", default: 0
    t.text "system_prompt"
    t.datetime "updated_at", null: false
    t.json "user_scripts", default: []
  ...
  create_table "checklists", force: :cascade do |t|
    ...
    t.text "user_scripts_ciphertext"
  ...
  create_table "document_files", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "updated_by_id"
    t.index ["account_id", "reference"], name: "index_document_files_on_account_id_and_reference"
  ...
  create_table "envelope_revisions", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "updated_by_id"
    t.index ["account_id"], name: "index_envelope_revisions_on_account_id"
  ...
  create_table "envelopes", force: :cascade do |t|
    ...
    t.text "inbound_metadata_ciphertext"
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.index ["user_id", "account_id", "read_at", "created_at"], name: "idx_notifications_user_account_unread"
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.index ["prefix_id"], name: "index_orders_on_prefix_id", unique: true
    t.index ["source", "order_ref"], name: "index_orders_on_external_order_ref", unique: true, where: "source LIKE 'external%' AND order_ref IS NOT NULL"
    t.index ["status"], name: "index_orders_on_status"
    t.index ["subscription_plan_id"], name: "index_orders_on_subscription_plan_id"
    t.index ["updated_by_id"], name: "index_orders_on_updated_by_id"
    t.index ["user_id"], name: "index_orders_on_user_id"
  end

  create_table "ref_files", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "checklist_id"
    t.datetime "created_at", null: false
    t.bigint "document_file_revision_id", null: false
    ...
    t.datetime "updated_at", null: false
    t.index ["account_id", "checklist_id", "rule_id"], name: "idx_ref_files_account_checklist_rule"
    t.index ["account_id"], name: "index_ref_files_on_account_id"
    t.index ["document_file_revision_id"], name: "index_ref_files_on_document_file_revision_id"
    t.index ["envelope_revision_id", "position"], name: "idx_ref_files_checklist_unique", unique: true, where: "rule_id IS NULL"
    t.index ["envelope_revision_id", "rule_id", "position"], name: "idx_ref_files_rule_unique", unique: true, where: "rule_id IS NOT NULL"
    t.index ["envelope_revision_id"], name: "index_ref_files_on_envelope_revision_id"
    t.index ["prefix_id"], name: "index_ref_files_on_prefix_id", unique: true
  end
  ...
  create_table "reports", force: :cascade do |t|
    ...
    t.datetime "inspection_enqueued_at"
    t.string "job_id"
    ...
    t.datetime "updated_at", null: false
    t.bigint "updated_by_id"
    t.text "user_scripts_output_ciphertext"
  ...
  create_table "subscription_plans", force: :cascade do |t|
    ...
    t.integer "max_security_level", default: 0, null: false
    t.string "name", null: false
    t.string "prefix_id"
    t.integer "price_cents", default: 0, null: false
    t.string "sku", null: false
    t.integer "sort_order", default: 0, null: false
    t.boolean "supports_hipaa", default: false, null: false
    t.datetime "updated_at", null: false
    t.string "url"
    t.index ["prefix_id"], name: "index_subscription_plans_on_prefix_id", unique: true
    t.index ["sku"], name: "index_subscription_plans_on_sku", unique: true
  end
  ...
  create_table "subscriptions", force: :cascade do |t|
    ...
    t.string "prefix_id"
    t.integer "previous_recurring_plan_id"
    t.integer "status", default: 0, null: false
    ...
    t.index ["external_id"], name: "index_subscriptions_on_external_id", unique: true, where: "external_id IS NOT NULL"
    t.index ["prefix_id"], name: "index_subscriptions_on_prefix_id", unique: true
    t.index ["previous_recurring_plan_id"], name: "index_subscriptions_on_previous_recurring_plan_id"
  ...
  create_table "tags", force: :cascade do |t|
    ...
    t.index ["account_id", "parent_tag_id"], name: "index_tags_on_account_id_and_parent_tag_id"
  ...
  add_foreign_key "envelope_revisions", "accounts"
  ...
  add_foreign_key "orders", "subscription_plans"
